...
<div class="card grid grid-cols-1 md:grid-cols-3 p-5 md:p-20 border border-primary-content gap-12">
	...
	<div class="col-span-1">
		...
		<form action="" class="mt-5">
			...
			<div class="mt-5 relative">
				...
				/>
				<button
					class="btn bg-gradient-to-r from-primary to-secondary absolute top-0 right-0 rounded-l-none"
					>Subscribe</button
				>
			</div>
		</form>
	...
	<div
		class="col-span-1 md:col-span-3 border-t border-primary-content flex flex-row justify-between pt-5 md:pt-20 md:mt-5"
	>
		<p>
			View source on <span
				class="text-primary hover:text-primary-focus transition duration-150 cursor-pointer"
				>Github</span
			>
		</p>

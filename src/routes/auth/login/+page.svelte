            ...
            <div class="mt-12">
                <form>
                    <div>
                        ...
                        <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="Enter your username">
                    </div>
                    <div class="mt-8">
                        <div class="flex justify-between items-center">
                            ...
                            <div>
                                <a href="register" class="text-xs font-display font-semibold text-indigo-600 hover:text-indigo-800
                                cursor-pointer">
                                    Facing Problems?
                                </a>
                            </div>
                ...
                <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                    Don't have an account ? <a href="register" class="cursor-pointer text-indigo-600 hover:text-indigo-800">Register</a>
                </div>
            </div>
        </div>
    </div>

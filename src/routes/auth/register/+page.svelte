...
<div class="lg:flex lg:flex-row">
    <div class="lg:w-1/2 xl:max-w-screen-sm">
        <div class="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-center lg:px-12">
            <div class="cursor-pointer flex items-center bg-indigo-500 text-white py-2 px-10 text-xl rounded-full shadow-lg tracking-wide
            font-semibold">
                brand name?
            </div>
        </div>
        <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-5 xl:px-24 xl:max-w-2xl">
            <h2 class="text-center text-3xl text-indigo-600 font-display font-semibold lg:text-left xl:text-5xl
            xl:text-bold"> Faculty Register</h2>
            <div class="mt-5">
                <form>
                    <div>
                        <div class="text-sm font-bold text-gray-700 tracking-wide">Username</div>
                        <input name="username" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="text" placeholder="Enter your username">
                    </div>
                    <div class="mt-5">
                        <div class="text-sm font-bold text-gray-700 tracking-wide">Full Name</div>
                        <input name="fullname" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="text" placeholder="Enter your full name">
                    </div>
                    <div class="mt-5">
                        <div class="text-sm font-bold text-gray-700 tracking-wide">Email</div>
                        <input name="email" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="email" placeholder="example@email.com">
                    </div>
                    <div class="mt-5">
                        <div class="text-sm font-bold text-gray-700 tracking-wide">Contact Number</div>
                        <input name="contact" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="number" placeholder="0000000000">
                    </div>
                    <div class="mt-5">
                    ...
                    <div class="mt-5">
                        ...
                        <input name="confirm" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="password" placeholder="Confirm password">
                    </div>
                    <div class="mt-10">
                        <button class="bg-indigo-500 text-gray-100 p-4 w-full rounded-full tracking-wide
                        font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-indigo-600 hover:scale-105 transition duration-200
                        shadow-lg">
                            Register now
                        </button>
                    </div>
                ...
                <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                    Already have an account? <a href="login" class="cursor-pointer text-indigo-600 hover:text-indigo-800">Login</a>
                </div>
            </div>
        </div>
    </div>

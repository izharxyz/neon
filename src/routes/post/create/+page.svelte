...
<div class="card border border-primary-content p-2">
	<h1 class="my-8">Write a wonderful article</h1>
	<form method="POST" use:enhance>
		...
		<input
			...
			type="text"
			placeholder="Excerpt"
			class="input input-bordered input-primary w-full mt-8"
		/>
		...
		<div class="flex flex-col md:flex-row my-8">
			...
			<input
				name="thumbnail"
				type="file"
				class="file-input file-input-bordered file-input-primary w-full md:w-1/2 mt-8 md:mt-0"
			/>
		</div>
		<div>
